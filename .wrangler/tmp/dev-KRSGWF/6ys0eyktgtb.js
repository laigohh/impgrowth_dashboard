...
// .wrangler/tmp/bundle-dnMLRu/checked-fetch.js
...
// .wrangler/tmp/pages-Nhq5jR/bundledWorker-0.9011461240387075.mjs
...
async function E(e, { request: t, assetsFetcher: a, ctx: s }, { path: n, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        r = S(await a.fetch(L(c, e.path ?? n))), e.headers && R(r.headers, e.headers);
        break;
      }
      case "static": {
...
// .wrangler/tmp/pages-Nhq5jR/6ys0eyktgtb.js
...
// .wrangler/tmp/bundle-dnMLRu/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-dnMLRu/middleware-loader.entry.ts
